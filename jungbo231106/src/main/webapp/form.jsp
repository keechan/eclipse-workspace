...
<body>
	...
	<% 
		int maxSno = (Integer) request.getAttribute("sno");
	%>	
	<section>
		<br>
			<div align="center">
			...
			<form name=f1 action="JungboController" onSubmit="return ck()">
				...
				<table border=1>
					...
					<tr><th width=60>학번</th><td><input type=text name=sno value=<%=maxSno %>></td></tr>
					<tr><th width=60>성명</th><td><input type=text name=sname></td></tr>
					<tr><th width=60>국어</th><td><input type=text name=kor></td></tr>
					<tr><th width=60>영어</th><td><input type=text name=eng></td></tr>
					<tr><th width=60>수학</th><td><input type=text name=math></td></tr>
					<tr><th width=60>역사</th><td><input type=text name=hist></td></tr>
					<tr><th width=60>등록일</th><td><input type=date name=today></td></tr>
