...
public class CommentController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (sw.equals("I")) {
			...
			System.out.println(sample6_postcode+ ":" + sample6_address + ":" + sample6_detailAddress + ":" +  sample6_extraAddress);
			
			vo.setPostCode(sample6_postcode);
			vo.setAddress(sample6_address);
			vo.setDetailAddress(sample6_detailAddress);
			vo.setExtraAddress(sample6_extraAddress);
